...
function createMenuItem(name, cost, category){
    const menuItem = {name:name, cost:cost, category:category};
    return menuItem;
}

console.log('Task 1a: ', createMenuItem('food', 10, 'dinner'));

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */

const pizza = createMenuItem('pizza', 2, 'Lunch');
const misoSoup = createMenuItem('Miso Soup', 5, 'Lunch');
const milkshake = createMenuItem('Milk Shake', 7, 'Drinks');

console.log('Task 1b: ', pizza, misoSoup, milkshake);
...
function getReviewByIndex(arr, num) {
  return `${arr[num].name} gave the restaurant a ${arr[num].rating} and their feed back was: ${arr[num].feedback}`;
}
